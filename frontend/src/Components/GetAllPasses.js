                    ...
                    <div>
                        <div className='p_info'>
                            <div className='v_info'>
                                {p.VisitorId && (
                                    <img src={`http://localhost:5000/${p.VisitorId.Photo}`} width="80" alt='Visitor Profile' />
                                )}
                        ...
                        Pdf File - <a href={`http://localhost:5000/${p.PdfFile}`} target='_blank' rel='noopener noreferrer' download>Download Visitor Pass</a>
                    </div>
                        <div className='check'>
